...
var file_Order_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x22, 0x39, 0x0a, 0x0d, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f,
	...
	0x08, 0x6e, 0x65, 0x77, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x12, 0x0f, 0x2e, 0x73, 0x65, 0x72, 0x76,
...
var file_Order_proto_depIdxs = []int32{
	1, // 0: services.OrderService.newOrder:input_type -> services.Order
...
type OrderServiceClient interface {
	NewOrder(ctx context.Context, in *Order, opts ...grpc.CallOption) (*OrderResponse, error)
}
...
func (c *orderServiceClient) NewOrder(ctx context.Context, in *Order, opts ...grpc.CallOption) (*OrderResponse, error) {
...
type OrderServiceServer interface {
	NewOrder(context.Context, *Order) (*OrderResponse, error)
}
...
func (*UnimplementedOrderServiceServer) NewOrder(context.Context, *Order) (*OrderResponse, error) {
